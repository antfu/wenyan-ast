...
export const KEYWORDS_ALL = {
  ...
  是謂: { type: TokenType.Control, value: 'functionEnd1' },
  之術也: { type: TokenType.Control, value: 'functionEnd2' },
  ...
  吾嘗觀: { type: TokenType.Import, value: 'importStart' },
  中: { type: TokenType.Import, value: 'importIn' },
  之書: { type: TokenType.Import, value: 'importEnd' },
  方悟: { type: TokenType.Import, value: 'importNameStart' },
  之義: { type: TokenType.Import, value: 'importNameEnd' },

  嗚呼: { type: TokenType.Throw, value: 'throwStart' },
  之禍: { type: TokenType.Throw, value: 'throwEnd' },
